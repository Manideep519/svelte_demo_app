  ...
  <SidebarWrapper class="bg-white">
    <SidebarGroup>
      ...
      <SidebarDropdownWrapper label="Sales">
        ...
        <SidebarDropdownItem label="Products" href="/demo-dashboard" />
        <SidebarDropdownItem label="Billing" href="/demo-dashboard" />
        <SidebarDropdownItem label="Invoice" href="/demo-dashboard" />
      </SidebarDropdownWrapper>
      <SidebarItem label="Messages" href="/demo-dashboard" {spanClass}>
        <svelte:fragment slot="icon">
          <svg
            aria-hidden="true"
      ...
      <SidebarDropdownWrapper label="Authentication">
        ...
        <SidebarDropdownItem label="Sign In" href="/demo-dashboard" />
        <SidebarDropdownItem label="Sign Up" href="/demo-dashboard" />
        <SidebarDropdownItem label="Forgot Password" href="/demo-dashboard" />
      </SidebarDropdownWrapper>
    </SidebarGroup>
    <SidebarGroup border>
      <SidebarItem href="/demo-dashboard" label="Docs" {spanClass}>
        <svelte:fragment slot="icon">
          <svg
            aria-hidden="true"
            class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
      ...
      <SidebarItem href="/demo-dashboard" label="Components">
        <svelte:fragment slot="icon">
          <svg
            aria-hidden="true"
            class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
      ...
      <SidebarItem href="/demo-dashboard" label="Help">
        <svelte:fragment slot="icon">
          <svg
            aria-hidden="true"
            class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
    ...
    <SidebarGroup class="relative pt-64">
      <SidebarBottomNav>
        <SidebarBottomNavItem href="/demo-dashboard" tooltip="Profile">
          <svg
            aria-hidden="true"
            class="w-6 h-6"
            fill="currentColor"
        ...
        <SidebarBottomNavItem href="/demo-dashboard" tooltip="Settings page">
          <svg
            aria-hidden="true"
            class="w-6 h-6"
            fill="currentColor"
